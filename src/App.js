...
let PokemonList = POKEMON.map(item => <PokemonCard key={ item.id } pokemon={item} imgBack={ImgBackCard} />);
...
function App() {
    return (
        <>
            ...
            <Layout id='2' title='Название 2' colorBg="#7be3fe">
                In the game two players face off against one another, one side playing as "blue", the other as "red"
                on a 3x3 grid.
                Each player has five cards in a hand and the aim is to capture the opponent's cards by turning them
                into the player's own color of red or blue.
            ...
            <Layout id='3' title='Название 3' urlBg={BgTwo}>
                In the game two players face off against one another, one side playing as "blue", the other as "red"
                on a 3x3 grid.
                Each player has five cards in a hand and the aim is to capture the opponent's cards by turning them
                into the player's own color of red or blue.
            ...
            <div className="flex">{PokemonList}</div>
            <Footer/>
        </>
    );
}
